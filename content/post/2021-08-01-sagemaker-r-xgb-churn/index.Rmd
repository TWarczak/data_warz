...
```{r chunk16, message=FALSE, warning=FALSE, cache=TRUE}
...
```{r chunk29, message=FALSE, warning=FALSE, cache=TRUE}
...
```{r chunk31, message=FALSE, warning=FALSE, cache=TRUE}
...
```{r chunk41, message=FALSE, warning=FALSE, cache=TRUE}
...
```{r chunk50, results='hide', cache=TRUE}
...
```{r chunk51, results='hide', cache=TRUE}
...
```{r chunk57, message=FALSE, warning=FALSE, cache=TRUE}
